...
define("components/base-component", ["require", "exports"], function (require, exports) {
    ...
    class Component {
        ...
        attach(insertAtBeinning) {
            this.hostElement.insertAdjacentElement(insertAtBeinning ? 'afterbegin' : 'beforeend', this.element);
        }
    }
...
define("decorator/autobind", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function autobind(_, _2, decsriptor) {
...
define("state/project-status", ["require", "exports", "models/project"], function (require, exports, project_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class State {
        constructor() {
...
define("components/project-input", ["require", "exports", "components/base-component", "util/validation", "decorator/autobind", "state/project-status"], function (require, exports, base_component_js_1, validation_js_1, autobind_js_1, project_status_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ProjectInput extends base_component_js_1.Component {
        ...
        submitHandler(event) {
            ...
            if (Array.isArray(userInput)) {
                ...
                project_status_js_1.projectState.addProject(title, desc, people);
                this.clearInputs();
            }
        }
        renderContent() { }
...
define("components/project-list", ["require", "exports", "components/base-component", "components/project-item", "models/project", "decorator/autobind", "state/project-status"], function (require, exports, base_component_js_3, project_item_js_1, project_js_2, autobind_js_3, project_status_js_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ProjectList extends base_component_js_3.Component {
        ...
        dropHandler(event) {
            ...
            project_status_js_2.projectState.moveProject(prjId, this.type === 'active' ? project_js_2.ProjectStatus.Active : project_js_2.ProjectStatus.Finished);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector('ul');
        ...
        configure() {
            ...
            project_status_js_2.projectState.addListener((projects) => {
